...
public class orderDTO implements Serializable{
         ...
         public orderDTO(String orderID, float totalPrice, int totalQuantity, String custName, String custAdress, String custPhone, LocalDateTime orderDateTime, String email, boolean status) {
