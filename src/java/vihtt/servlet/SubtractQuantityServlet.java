 ...
 * @author Thanh Vi
 */
@WebServlet(name = "SubtractQuantityServlet", urlPatterns = {"/SubtractQuantityServlet"})
public class SubtractQuantityServlet extends HttpServlet {
private final String VIEW_CART = "ViewCartServlet";
private static final Logger LOGGER = LogManager.getLogger(SubtractQuantityServlet.class);
         /**
                 ...
                 throws ServletException, IOException {
                  ...
                  if(ID == null){
                           ...
                           try {
                                    ...
                                    if (quantity > 0) {
                                             if ((orderQuantity - 1) <= quantity && (orderQuantity - 1) >= 1) {

                                                      cart.subtractQuantityToCard(ID, orderQuantity - 1);
                                    ...
                                    LOGGER.error("SubtractQuantityServlet_NumberFormatException ", e);
                           }catch(SQLException e)  {
                                    LOGGER.error("SubtractQuantityServlet_SQLException ", e);
                           }catch(NamingException ex)  {
                                    LOGGER.error("SubtractQuantityServlet_NamingException ", ex);
                           }finally{
