<%-- 
    Document   : viewSystemHistory
    Created on : Jan 20, 2021, 8:19:07 PM
    Author     : Thanh Vi
--%>
...
<html>
          <head>
                  ...
                  <title>System History Page</title>
                  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         ...
         <body>
                                    ...
                                    <ul>
                                             <c:if test="${not empty sessionScope.NAME}">
                                                      <c:if test="${not sessionScope.ROLE_OF_USER}">
                                                               ...
                                                               <li><a href="ViewSystemHistoryServlet" title="View History" style="border-bottom: 3px solid black; background: #ffffff;"><i class="fas fa-history"></i></a></li>
                                                               </c:if>
                  ...
                  <div id="viewcart_form">
                           <c:if test="${not empty requestScope.SYSTEM_HISTORY}">
                                             <table border="1" id="tb">
                                                      ...
                                                      <tbody>
                                                               <c:forEach var="history" items="${requestScope.SYSTEM_HISTORY}" varStatus="counter">
                                                                        <tr>
                                                                                 <td><p>${counter.count}</p></td>
                                                                                 <td><p>${history.itemID}</p></td>
                                                                                 <td><div id="item_imagecart">
                                                                                                   <img src="Image/${history.image}" id="imgCart" />
                                                                                          </div>
                                                                                 </td>
                                                                                 <td><p>${history.name}</p></td>
                                                                                 <td><p>${history.content}</p></td>
                                                                                 <td><p>${history.contentDetail}</p></td>
                                                                                 <td><p>${history.updateDate}</p></td>
                                                                        </tr>
                                                               </c:forEach>    
                                                      </tbody>
                                             </table>
                           ...
                           <c:if test="${empty requestScope.SYSTEM_HISTORY}">
                                    <div id="invalid">
