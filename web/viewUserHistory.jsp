...
<html>
         ...
         <body>
                  ...
                  <div id="categories_history">   
                                    <a href="ViewUserHistoryServlet" class="ctgr" style="border-bottom: 3px solid black;background: #F5A9BC;">View History</a>
                                    <a href="searchUserHistory.jsp" class="ctgr" >Search History</a>
                  </div>
